...
public class RazorpayPaymentGateway implements PaymentGateway {
    ...
    public String generatePaymentLink(Long orderId, String email) throws RazorpayException {
        ...
        paymentLinkRequest.put("expire_by", 1714735800);
        paymentLinkRequest.put("reference_id", "15423456");
        paymentLinkRequest.put("description", "Sample payment for project by Nymish");
        JSONObject customer = new JSONObject();
        customer.put("name", "+918105598855");
        customer.put("contact", "Nymish K");
